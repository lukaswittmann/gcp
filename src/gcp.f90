...
! Lower case and delete hyphends
...
do while (index(method,'(').ne.0)
   i=scan(method,'(')
   ctmp=trim(method(:(i-1)))//'_'//trim(method((i+1):))
   method=trim(ctmp)
enddo
...
real(8) HFsv(apar),HFminis(apar),HF631gd(apar),HFsvp(apar),HFtz(apar),&
      ...
      HFmtz2p(apar), & ! TG ,HFstosz(apar),HFstodz(apar),HFstodzp(apar),HFstotzp(apar),HFstotz2p(apar)
...
!! Testing stoDZ parameters for stoSZ
0.0093162,0.0026660,&
...
! data DFTstosz /&    !LW 
! 0.0113665,-0.0026661,&
! -0.0683415,-0.0401105,-0.0102269,0.0401202,0.02012,0.004302,-0.0022286,-0.0051324,&
! -0.1344337,-0.0968888,-0.0846782,-0.0150534,-0.0043123,-0.0239558,-0.0005422,-0.0217676,&
! -0.1796566,-0.1409391,&
! -0.1217504,-0.1269695,-0.0948602,0.3162983,0.0283838,0.2318777,0.3579417,1.4891966,1.7580383,0.7176784,&
! 0.0179623,-0.0662198,-0.0247831,-0.0367923,-0.0131961,-0.0334845/
...
! data DFTstodz /&    !LW
! 0.0093162,0.002666,&
! 0.0347043,0.0192966,0.0136153,-0.0187107,0.0072526,0.01101,0.007391,0.0046155,&
! 0.0519006,0.0337027,0.062552,0.0286141,0.0303191,0.0367436,0.002597,0.0194538,&
! 0.0774084,0.0634475,&
! 0.0528031,0.0522268,0.0517424,0.0474416,0.0436001,0.0389728,0.0358599,0.0301923,0.0279932,0.0337027,&
! 0.1436621,0.0842534,0.0463178,0.0466894,0.0162174,0.0289199/
...
! data DFTstodzp /&    !LW
! 0.0038873,0.0005262,&
! 0.0293667,0.0192941,0.0123389,-0.0203297,0.0061805,0.0078527,0.0042589,0.0017846,&
! 0.0465395,0.0334048,0.0656873,0.0245531,0.0260687,0.0311969,-0.0048173,0.0116849,&
! 0.0758255,0.0619573,&
! 0.0497797,0.0499545,0.0485491,0.0450981,0.0420787,0.0375948,0.0350183,0.0284127,0.0279771,0.033217,&
! 0.1316143,0.0713194,0.0293466,0.0318998,0.0010842,0.0114059/
...
! data DFTstotzp /&    !LW
! 0.0036474,-5.82e-05,&
! 0.0196771,0.0073681,0.0118646,-0.0214378,0.0053941,0.0065586,0.0028702,0.0009493,&
! 0.0449693,0.0315244,0.0261257,0.0177686,0.0214806,0.0293704,-0.0060203,0.0100644,&
! 0.0620405,0.0559451,&
! 0.0497797,0.0499545,0.0485491,0.0450981,0.0420787,0.0375948,0.0350183,0.0284127,0.0279771,0.033217,&
! 0.1068441,0.053123,0.0242398,0.0199246,-0.0006931,0.0083213/
...
! data DFTstotz2p /&    !LW
! 0.0036427,-6.19e-05,&
! 0.019634,-0.0017049,0.0118191,-0.0214969,0.005394,0.0054883,0.0018323,0.0009488,&
! 0.0449058,0.0066426,0.0261107,0.0340417,0.0214802,0.0280336,-0.0075345,0.0100622,&
! 0.0620294,0.0520004,&
! 0.0488054,0.04872,0.0919678,0.0449576,0.0419981,0.0370549,0.0343443,0.0279588,0.0277663,0.0332156,&
! 0.1065026,0.0676884,0.024147,0.0189513,-0.0025184,0.0082922/


! Emiss data for DFT with ORCA 5.0.3. ROHF, efield 0.03464, 0.03464, 0.03464
data DFTdef2mSVP /& !WL
0.0105882,0.0088428,&
...
data BASdef2mTZVPP /& !WL: fixed nbas according to orca output
5,5,&
...
! fit param of DFT/MINIS
  ...
  case('dft/dz','b3lyp/dz')
   ...
   case ('dft/stosz')
      ...
      !! parameters using Emiss from stoDZ
      !0.30366623 2.64217233 0.34345161 2.06684754
      p(1)=0.30366d0
      p(2)=2.64217d0
      p(3)=0.34345d0
      p(4)=2.06684d0
...
subroutine availpars()
   ...
   print*,'        -            DFT/def2-mSVP'
   print*,'        -            DFT/def2-SVPD'
   print*,'        -            DFT/def2-mTZVP'
   print*,'        -            DFT/def2-mTZVPP'
   print*,'        -            DFT/ma-def2-mSVP'
   print*,'        -            DFT/ma-def2-SVP'
   print*,'        -            DFT/ma-def2-SV(P)'
   print*,'        -            DFT/ma-def2-TZVP'
   print*,'        -            DFT/ma-def2-TZVP(-f)'
   print*,'                                   '
   print*,'        -            DFT/stoSZ'
   print*,'        -            DFT/stoDZ'
   print*,'        -            DFT/stoDZP'
